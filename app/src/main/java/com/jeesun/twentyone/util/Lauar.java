...
public final class Lauar {
    ...
    public static String getChinaDate(String year, String month, String day){
    	Date sDObj;
        String s;
        int SY, SM, SD;
        SY = Integer.parseInt(year);
    ...
    public static String getChinaDate(Date date){
        ...
        return getChinaDate(String.valueOf(cl.get(Calendar.YEAR)),
                String.valueOf(cl.get(Calendar.MONTH)),
                String.valueOf(cl.get(Calendar.DAY_OF_MONTH)));
    }
    
    public static String getWeekOfDate(Date dt) {
        String[] weekDays = {"周日", "周一", "周二", "周三", "周四", "周五", "星期六"};
    ...
    public static String getChinaMonthAndDay(Date date){
    	Calendar cal = Calendar.getInstance();
    	cal.setTime(date);
