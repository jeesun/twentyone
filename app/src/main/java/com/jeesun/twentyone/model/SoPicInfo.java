...
public class SoPicInfo {
    ...
    public boolean isQqfaceDownUrl() {
    ...
    public void setThunmb(String thunmb) {
        this.thunmb = thunmb;
    }
    ...
    public String get_thunmb() {
        return _thunmb;
    }

    public void set_thunmb(String _thunmb) {
        this._thunmb = _thunmb;
    }
